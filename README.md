...
#### 4.1.1. Основной исполняемый файл
```main.py
...
#### 4.1.2. Основной модуль банковских счетов
``` /src/lambda_bank.py
...
#### 4.1.3. Модуль банковского счёта
```/src/account.py
from decimal import Decimal
...
#### 4.1.5. Модуль сберегательного счёта
